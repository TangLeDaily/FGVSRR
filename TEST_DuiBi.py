...
from dataset_E_9 import *
from torch.utils.data import DataLoader
from util import *
from rootmodel import TGA
from rootmodel import TGA_SP

wandb.init(project="TEST_DB_Other", name="TGA", entity="karledom")

dpsnr_avg_list = []
dssim_avg_list = []
def main(name):
    model_our = TGA_SP.TGA()
    model_other = TGA.TGA()
    ...
    state_dictA = torch.load("checkpoints/New_Over/TGA_SP_L7FSR/model_epoch_148_psnr_29.1873.pth", map_location='cpu')
    ...
    state_dictB = torch.load("checkpoints/New_Over/TGA_L7FSR/model_epoch_51_psnr_28.6641.pth", map_location='cpu')
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(dataloader):
            ...
            save_pic(out_A[0,:,:,:], "data/5_25_test/{}/TGA_SP/".format(name), "pic_{}_psnr_{:.4f}_DT_{:.4f}.png".format(i, psnr_now_A, DT_psnr))
            save_pic(out_B[0, :, :, :], "data/5_25_test/{}/TGA_low/".format(name),
