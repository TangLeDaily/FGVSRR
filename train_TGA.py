...
def get_yu(model):
    kk = torch.load("checkpoints/over/PFNL_26d85/model_epoch_484_psnr_26.9643.pth", map_location='cpu')
...
def test_train_set(this_model, test_loader, epoch_num):
    ...
    with torch.no_grad():
        ...
        print("--->This--TGA--epoch:{}--Avg--PSNR: {:.4f} dB--Root--PSNR: 24.11 dB".format(epoch_num,
                                                                                               psnr.avg))
    return psnr.avg
