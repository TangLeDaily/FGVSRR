...
from util import *
from rootmodel.EDVR_SP128_2FSR import *

use_wandb = False
Project_name = "SPVSR_V2"
This_name = "EDVR_SP128_2FSR"
...
def get_yu(model):
    kk = torch.load("/home/tangle/code/FGVSR/checkpoints/SPLSTM_64C_2FSR/model_epoch_187_psnr_29.5802.pth", map_location='cpu')
