...
from util import *
from checkpoints.New_Over.EDVR_L5FSR.edvr_5 import *

def main(name):
    model = EDVR()
    checkpoint = torch.load("checkpoints/New_Over/EDVR_L5FSR/model_epoch_100_psnr_29.7487.pth", map_location='cpu')
    ...
    with torch.no_grad():
        for i, batch in enumerate(dataloader):
            ...
            save_pic(out[0, :, :, :], "data/{}/EDVR_L5FSR/".format(name), "{}output.png".format(i))
