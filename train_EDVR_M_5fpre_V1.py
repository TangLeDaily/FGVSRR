...
from rootmodel.EDVR_M_5 import *
...
def main():
    ...
    checkpoint = torch.load("checkpoints/EDVR_M_5f_pre_V1/model_epoch_14_psnr_27.0830.pth", map_location='cpu')
...
def save_checkpoint(model, psnr, epoch):
    ...
    if opt.model_mark == 0:
        model_folder = "checkpoints/EDVR_M_5f_pre_V1/"
    else:
...
def test_train_set(this_model, epoch_num):
    ...
    with torch.no_grad():
        ...
        print("--->This--EDVR_M_5f_pre_V1--epoch:{}--Avg--PSNR: {:.4f} dB--Root--PSNR: 24.11 dB".format(epoch_num,
                                                                                               psnr.avg))
    return psnr.avg
