...
def main():
    ...
    checkpoint = torch.load("/home/tangle/code/FGVSR/checkpoints/RCAN/model_epoch_0_psnr_25.6576.pth", map_location='cpu')
...
def save_checkpoint(model, psnr, epoch):
    ...
    if opt.model_mark == 0:
        model_folder = "checkpoints/RCAN_1FSRRCAN_1FSR/"
    else:
...
def test_train_set(this_model, epoch_num):
    ...
    with torch.no_grad():
        ...
        print("--->This--RCAN_1FSR--epoch:{}--Avg--PSNR: {:.4f} dB--Root--PSNR: 24.11 dB".format(epoch_num,
                                                                                               psnr.avg))
    return psnr.avg
