...
class train_data_set(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        lr_final.append(lrNN[0])
        lr_final.append(lrCC)
        lr_final.append(lrNN[1])

        lr_final.append(lrNN[2])
        lr_final.append(lrCC)
        lr_final.append(lrNN[3])

        lr_final.append(lrNN[4])
        lr_final.append(lrCC)
        lr_final.append(lrNN[5])
...
class test_data_set(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        lr_final.append(lrN[0])
        lr_final.append(lrc)
        lr_final.append(lrN[1])

        lr_final.append(lrN[2])
        lr_final.append(lrc)
        lr_final.append(lrN[3])

        lr_final.append(lrN[4])
        lr_final.append(lrc)
        lr_final.append(lrN[5])
...
if __name__ == "__main__":
    ...
    training_data_loader = DataLoader(dataset=dataset, batch_size=1, num_workers=0,
                                      drop_last=True)
    test_set = test_data_set("datasets/test/REDS4/", "000/")
