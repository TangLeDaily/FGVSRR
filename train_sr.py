...
def main():
    ...
    if opt.model_mark == 0:
        ...
        str = "ERROR"
    if use_wandb:
        wandb.init(project="EDVR-f2", name=str, entity="karledom")
    print(opt)
...
def save_checkpoint(model, videoid, epoch):
    ...
    torch.save(model.state_dict(), "checkpoints/edvr/state/model_videoID_{}_epoch_{}_state.pth".format(videoid[:-1], epoch))
