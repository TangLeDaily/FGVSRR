...
class RandomCrop(object):
    ...
    def __call__(self, sample):
        lrC, hr, ranintX, ranintY = sample['lrC'], sample['hr'], sample['ranintX'], sample['ranintY']
...
class train_data_set(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample = {'lrC': lrC, 'hr': hr, 'ranintX': self.randintX[video_ID], 'ranintY': self.randintY[video_ID]}
        lrCC, hrr = self.crop(sample)
        return lrCC, hrr, self.randintX[video_ID]
