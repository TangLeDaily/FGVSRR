...
from rootmodel.EFVSR_L_OnlypcdThreeDSLSTM_V1 import *
...
def get_yu(model):
    kk = torch.load("checkpoints/EFVSR_L_OnlypcdThreeLSTM/model_epoch_158_psnr_27.4050.pth", map_location='cpu')
...
def main():
    ...
    str = "None"
    if opt.model_mark == 0:
        str = "EFVSR_L_OnlypcdThreeDSLSTM_V1"
    else:
        str = "ERROR"
    if use_wandb:
...
def train(optimizer, model, criterion, epoch, train_dataloader):
    ...
    for iteration, batch in enumerate(train_dataloader):
        ...
        feat_ID = iteration // opt.frame + 4000
