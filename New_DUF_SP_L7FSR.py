...
from dataset_E_7 import *
from util import *
from rootmodel.DUF_SP_L7FSR import *

use_wandb = False
Project_name = "SPVSR_V2"
This_name = "DUF_SP_L7FSR"
...
parser.add_argument("--lr", type=float, default=2.7487790694400027e-05, help="Learning Rate. Default=1e-4")
