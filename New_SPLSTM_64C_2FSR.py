...
parser.add_argument("--lr", type=float, default=3.435973836800003e-05, help="Learning Rate. Default=1e-4")
parser.add_argument("--threads", type=int, default=16, help="number of threads for data loader to use")
opt = parser.parse_args()

def get_yu(model):
    kk = torch.load("/home/tangle/code/FGVSR/checkpoints/SPLSTM_64C_2FSR_Direct/model_epoch_216_psnr_27.0081.pth", map_location='cpu')
