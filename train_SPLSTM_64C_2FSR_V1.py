...
from util import *
from rootmodel.SPLSTM_64C_2FSR_V1 import *
...
def save_checkpoint(model, psnr, epoch):
    ...
    if opt.model_mark == 0:
        model_folder = "checkpoints/SPLSTM_64C_2FSR_DCN/"
    else:
...
def test_train_set(this_model, test_loader, epoch_num):
    ...
    with torch.no_grad():
        ...
        print("--->This--SPLSTM_64C_2FSR_DCN--epoch:{}--Avg--PSNR: {:.4f} dB--Root--PSNR: 24.11 dB".format(epoch_num,
                                                                                               psnr.avg))
    return psnr.avg
