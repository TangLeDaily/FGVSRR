...
from util import *
from rootmodel.muCAN_SPCN_2FSR import *

use_wandb = True
Project_name = "SPVSR_V2"
This_name = "MuCAN_SPCN_2FSR"
...
def get_yu(model):
    kk = torch.load("/home/tl/code/FGVSR/checkpoints/MuCAN_SP_2FSR/model_epoch_95_psnr_29.4866.pth", map_location='cpu')
...
def main():
    ...
    # checkpoint = torch.load("/home/tl/code/FGVSR/checkpoints/MuCAN_SP_2FSR/model_epoch_17_psnr_29.4639.pth", map_location='cpu')
