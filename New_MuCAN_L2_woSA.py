...
from util import *
from rootmodel.muCAN_L2_woSA import *

use_wandb = False
Project_name = "SPVSR_AAAI"
This_name = "MuCAN_L2_woSA"
...
def main():
    ...
    # checkpoint = torch.load("/home/tl/code/FGVSR/checkpoints/muCAN/model_epoch_7_psnr_26.0006.pth", map_location='cpu')
